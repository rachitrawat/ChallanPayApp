...
/**
 * Helper methods related to requesting and receiving User data from server.
 */
public final class QueryUtils {
    ...
    /**
     * Query the server and return appropriate user object
     */
    public static User fetchUserData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a {@link User} object
        User UserObj = extractFeatureFromJson(jsonResponse);
    ...
    /**
     * Return a {@link User} object that has been built up from
