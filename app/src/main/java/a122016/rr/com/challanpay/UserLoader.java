...
/**
 * Loads a User by using an AsyncTask to perform the
...
public class UserLoader extends AsyncTaskLoader<User> {
    ...
    public User loadInBackground() {
        ...
        // Perform the network request, parse the response, and extract a User
        User UserObj = QueryUtils.fetchUserData(mUrl);
        Log.i(LOG_TAG, UserObj.getmName());
        return UserObj;
    }
}
